...
class Transformer_at_attn(Transformer):
    def forward(self, src,tgt, en_pos_embed, de_pos_embed, tgt_mask=None,padding_mask=None):
        ...
        hs = self.decoder.forward(tgt, memory,tgt_mask=tgt_mask, memory_key_padding_mask=padding_mask,
                          pos=en_pos_embed, query_pos=de_pos_embed)
        return hs, memory
    pass 
